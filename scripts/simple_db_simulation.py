...
def generate_personal_data(profession: str) -> Dict[str, Any]:
    """
    Генерирует персональные данные согласно требованиям.
    
    Возрастные ограничения:
    - Все агенты: от 18 до 65 лет (согласно requirements)
    - Политик: от 35 лет (но не больше 65)
    - Учитель и Доктор: от 30 лет (но не больше 65)
    """
    # Определяем возрастные ограничения (max 65 согласно requirements)
    min_age = 18
    ...
    max_age = 65  # Согласно requirements: 18-65 лет
